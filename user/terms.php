...
<section class="col-span-1 w-full flex items-center justify-center px-6">
  <main class="w-full max-w-3xl card p-8 rounded-lg shadow-lg bg-white text-black dark:bg-gray-900 dark:text-white">
    <h1 class="text-3xl font-extrabold mb-4 text-center">Terms & Conditions</h1>
    ...
    <p>By accessing and using this system, you agree to comply with and be bound by these Terms & Conditions. If you do not agree, you must discontinue use immediately.</p>

    <h2 class="text-xl font-semibold mt-6">2. Authorized Use</h2>
    <p>This system is intended for authorized employees only. Any unauthorized access, use, or attempt to manipulate system data is strictly prohibited and may result in disciplinary or legal action.</p>

    <h2 class="text-xl font-semibold mt-6">3. User Responsibilities</h2>
    <ul class="list-disc ml-6 space-y-1">
      <li>Keep your login credentials secure and confidential.</li>
      <li>Ensure the accuracy of any data you input into the system.</li>
      <li>Report immediately any suspected security breaches to the administrator.</li>
    </ul>

    <h2 class="text-xl font-semibold mt-6">4. System Availability</h2>
    <p>While we strive to ensure system reliability, we do not guarantee uninterrupted access. Maintenance, updates, or technical issues may cause temporary downtime.</p>

    <h2 class="text-xl font-semibold mt-6">5. Data Protection</h2>
    <p>All personal and organizational data handled by this system is protected under the Data Privacy Act and ISO 27001 standards. Misuse of data is strictly prohibited.</p>

    <h2 class="text-xl font-semibold mt-6">6. Amendments</h2>
    <p>We reserve the right to update or revise these Terms & Conditions at any time. Continued use of the system indicates acceptance of such changes.</p>

    <h2 class="text-xl font-semibold mt-6">7. Contact</h2>
    <p>For any questions regarding these Terms & Conditions, please contact the system administrator or HR representative.</p>
